...
RSpec.describe Garden do
  ...
  it 'can sort plants as well as list unique plants that take 100 or less day to harvest' do
    garden = Garden.create!(name: "Turing Community Garden", organic: true)
    ...
    Variety.create!(plot: plot_2, plant: plant_4)
    Variety.create!(plot: plot_2, plant: plant_2)
    Variety.create!(plot: plot_2, plant: plant_3)

    Variety.create!(plot: plot_3, plant: plant_4)
    Variety.create!(plot: plot_3, plant: plant_2)
